...
# class (dining-context images), but is not a substitute for a purpose-built weapon
# detector — see app/weapon/mock_adapter.py and docs/ai-pipeline.md for that limitation.
COCO_CLASSES = [
